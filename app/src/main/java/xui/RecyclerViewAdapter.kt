 ...
 * RecyclerView通用数据绑定
 */
abstract class RecyclerViewAdapter<T> @JvmOverloads constructor(protected val layoutResId: Int) : RecyclerView.Adapter<BaseViewHolder>() {
     ...
     * @param position
     */
    abstract fun onBind(holder: BaseViewHolder, item: T, position: Int)


    fun itemClickDoing(doing: (Int) -> Unit) {
